use crate::dummy_generator::DummyGenerator;
...
impl GeneratorRegistry {
    ...
    pub fn new_with_dummy_generators(enabled_subnets: HashSet<ExecutionProofSubnetId>) -> Self {
        ...
        for subnet_id in enabled_subnets {
            generators.insert(
                subnet_id,
                Arc::new(DummyGenerator::new(subnet_id)) as DynProofGenerator,
            );
        }
    ...
    /// Register a generator for a specific subnet
    ...
    /// Get a generator for a specific subnet
...
mod tests {
    ...
    fn test_dummy_generators_registry() {
        ...
        // Check specified subnets are registered
        ...
        // Check other subnets are not registered
    ...
    fn test_register_generator() {
        ...
        let generator = Arc::new(DummyGenerator::new(subnet_id));
