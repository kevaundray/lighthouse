...
pub struct BeaconChain<T: BeaconChainTypes> {
    ...
    /// Stateless execution layer for proof-based validation (if configured).
    pub stateless_execution_layer: Option<Arc<stateless_execution_layer::StatelessExecutionLayer>>,
